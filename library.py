...
class Library:
    ...
    def list_books(self):
        ...
        if not lines:
            ...
            for line in lines:
                ...
                date = book_info[3]
                time = book_info[4]
                text3 = tk.Label(text=f"Book: {book_name},   Author: {author},   Pages:{page},   Date:{date},   Time:{time}",font='Times 17')
                text3.pack()
                text3.place(x=x,y=y)
                y += 40
    ...
    def add_book(self,book_name,author,page,date):
        ...
        text4 = tk.Label(text=f"Book '{book_name}' by {author} added successfully.")
        text4.pack()
        text4.place(x=110,y=270)
    ...
    def time(self):
        ...
        self.time_label.place(x=1000,y=50)
